...
const ContactForm = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="pt-8 max-sm:w-full"
    >
      {!complete && (
        <div className="sm:w-[600px]  max-sm:max-w-full flex justify-center bg-[#1F2833] rounded-xl text-[#66fcf1] mt-8 border-2 border-[#1F2833] mb-16 ">
          <form
